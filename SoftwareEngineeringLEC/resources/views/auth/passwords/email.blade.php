        ...
        <div class="container-fluid" >
              <div class="row" style="min-height:100vh">
                    ...
                    <div class="col-6 p-0 py-3 px-5" style="background: #090909" id="login_register">
                        ...
                        <form class="d-flex flex-column px-5 py-3" style="font-family: Inter;" method="POST" action="{{ route('password.email') }}" style="height: 100vh">
                                @csrf
                                ...
                                <div class="d-flex justify-content-center align-items-center gap-5" style="font-family: 'Oswald', sans-serif; font-size: 30px;margin-bottom:50px">
                                    <a href="{{ route('login') }}" rel="Login" style="color: #ffffff; text-decoration: none;">{{ __('Forgot Password') }}</a>
                                ...
                                <button type="submit" class="btn py-2 mt-4" style="background: linear-gradient(45deg, #E200F7,#04BBEC);
                                    border: none; font-size: 16px; color: #FFFFFF; font-weight: 500;">{{ __('Send Password Reset Link') }}</button>
