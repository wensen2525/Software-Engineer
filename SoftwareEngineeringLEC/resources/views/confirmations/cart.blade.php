      ...
      <div class="container">
            <div class="row">
                  <div class="col">
                        ...
                        <div class="col-12">
                              <li>{{ $confirmation->codeConfirmation }}</li>
                              <li>{{ $paymentMethod->nameaccount . $paymentMethod->numberaccount}}</li>
                              <li>{{ $address->nameaddress }}</li>
                        </div>
                        <hr>
                        @endforeach

                        <form action="{{ route('confirmations.carts_confirm') }}" method="post" enctype="multipart/form-data">
                              @csrf
                              @method('UPDATE')
            ...
            <section>
                        ...
                        <div class="col-12 mt-3">
                              ...
                              <div class="card text-white" style="background-color: #2A2A2A; height: 100%;">
                                    ...
                                    <div class="col text-end">Rp {{ number_format($totalPriceProducts,0,',','.') }}</div>
                                    </div>
